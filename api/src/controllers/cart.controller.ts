...
import { addProductCart, createCart, getcartById, removeProductCart } from '../services/cart.service';
...
router.delete('/removeProductCart', async (req: Request, res: Response) => {
    try {
        const { cartid, productid } = req.body;
